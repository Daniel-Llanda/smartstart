...
class _ColorsPageState extends State<ColorsPage> {
  ...
  List<Map<String, dynamic>> getColorItems() {
    ...
    return [
      ...
      {'label': isTagalog ? 'Kayumanggi' : 'Brown', 'color': Colors.brown},
      {'label': isTagalog ? 'Puti' : 'White', 'color': Colors.white},
      {'label': isTagalog ? 'Abo' : 'Gray', 'color': Colors.grey},
      {'label': isTagalog ? 'Ginto' : 'Gold', 'color': const Color(0xFFFFD700)},
    ];
  }

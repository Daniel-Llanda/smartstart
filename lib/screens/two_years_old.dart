...
import 'two/colors_page.dart';
import 'two/shapes_page.dart';
import 'two/numbers_page.dart';
import 'two/alphabets_page.dart';
import 'two/animals_page.dart';
import 'two/bodyparts_page.dart';

class NumberTwoScreen extends StatefulWidget {
  final String selectedLanguage;

  const NumberTwoScreen({super.key, required this.selectedLanguage});

  @override
  State<NumberTwoScreen> createState() => _NumberTwoScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset('assets/images/two.png', fit: BoxFit.cover),
          ),
          Positioned(
            top: 40,
            left: 10,

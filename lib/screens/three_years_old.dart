...
import 'three/colors_page.dart';
import 'three/shapes_page.dart';
import 'three/numbers_page.dart';
import 'three/alphabets_page.dart';
import 'three/animals_page.dart';
import 'three/bodyparts_page.dart';

class NumberThreeScreen extends StatefulWidget {
  final String selectedLanguage;

  const NumberThreeScreen({super.key, required this.selectedLanguage});

  @override
  State<NumberThreeScreen> createState() => _NumberThreeScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset('assets/images/three.png', fit: BoxFit.cover),
          ),
          Positioned(
            top: 40,
            left: 10,
